...
def CreateDataWithDuplicates(directoryPath):  
    ...
    for i in range(len(dictShortNames)):
        ...
        dataDic.append({'Country': infosFile[0], 'Company': infosFile[1], 'Year': infosFile[2], 
                        ...
                        'Scan': isScan[:-1],'Pages_Number': pagesTotalNumber, 'Language_Expected': infosFile[3], 
                        'Language_Estimated': estimatedLanguage[:-1]})
...
CreateData(directoryPath = 'Annual reports', isMultiprocessing = 1)